          ...
          >
            <Grid container spacing={1}>
              ...
              >
                <Grid container>
                  <Grid item xs={12}>
                    <h1 className="key-title">Create Keyword Notification</h1>
                  </Grid>
                  <div className="inputfield-cont">
                    <div className="ultimate-container sup">
                      <div>
                        {/* end here */}
                        ...
                        <Grid item>
                          ...
                          <Grid item xs={12} md={12} className="key-container">
                            {info ? (
                              <div>
                                <div
                                  className="info-blur"
                                ...
                                <div className="info-container">
                                  <ul className="instruction-list">
                                    ...
                                    <li>
                                      enter the particular word, phrase or
                                      sentence you want to set notification for
                                      and then the website. The website should
                                      start with <b>http://</b> or
                                      <b> https://</b>
                                    </li>
                                    <li>
                                      select the messaging platform you wish to
                                      get notification
                                    </li>
                                    <li>click create</li>
                                    <li>
                                      you can edit your search in the status
                                      panel
                                    </li>
                                    <li>
                                      Once your keyword gets a perfect or
                                      partial match, the search will
                                      stop/unmount. But you can mount it if
                                      still needed.
                                    </li>
                                    <li>
                            ...
                            <Grid item xs={12} md={6}>
                              {check == 1 && (
                                <div>
                                  ...
                                  />
                                  {web1 != null &&
                                    !web1.startsWith("http://") &&
                                    !web1.startsWith("https://") && (
                                      <p
                                        style={{
                                          fontSize: "0.7rem",
                                          width: "16rem",
                                  ...
                                  <Grid item xs={12}>
                                    <Link href="/dashboard/keyword-notification/#status">
                                      <div
                              ...
                              {check == 6 && days > "0" && (
                                <div className="keyword-limit">
                                  <p>
                                    You have used up your five input limit. But
                                    you can delete an input you no longer need
                                    from the notification status panel. Thanks
                                    &#128151;
                                  </p>
                                </div>
                              )}
                    ...
                    <div className="ultimate-container sub">
                      <h2
                        id="status"
                        style={{
